let wasm_bindgen = (function(exports) {
     ...
     * @param {string} mode
     */
    function configure(sample_rate, fft_size, mode) {
        const ptr0 = passStringToWasm0(mode, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.configure(sample_rate, fft_size, ptr0, len0);
    }
     ...
     * @returns {Uint8Array}
     */
    function generate_mock_iq(num_bytes) {
        const ret = wasm.generate_mock_iq(num_bytes);
        return ret;
    }
    exports.generate_mock_iq = generate_mock_iq;
     ...
     * @returns {any}
     */
    function process_iq(data) {
        const ptr0 = passArray8ToWasm0(data, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.process_iq(ptr0, len0);
        return ret;
    }
    exports.process_iq = process_iq;
